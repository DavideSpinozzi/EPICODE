        ...
        <ng-container *ngIf="TaskIncomplete(); else noTasks">
          <tr *ngFor="let todo of todos">
            <ng-container *ngIf="!todo.completed;">
              ...
              <td>
                <!--<ng-container *ngIf="editingTask === todo">
                  <input type="text" [(ngModel)]="editedTaskTitle" />
                </ng-container>
                <ng-container *ngIf="editingTask !== todo">{{ todo.title }}</ng-container>-->
              </td>
              <td>
                <div class="d-flex justify-content-end">
                  <!--<svg
                    *ngIf="editingTask !== todo"
